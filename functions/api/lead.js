 ...
 *
 * Server-side mirror of the browser Pixel's "Lead" event, sent to Meta's
 * Conversions API when the lead-capture modal's Fieldd form is submitted
 * successfully. Sibling of /api/paint-inspection-click — same contract:
 *   - event_id     one UUID per successful submit, also passed to the Pixel
 *                  as eventID → Meta deduplicates the browser + server pair
 ...
 *
 * The client (src/components/LeadCaptureModal.astro) posts here via
